...
export class ABRGrade extends ABRAbstract {
    ...
    private _bitrateRecoveryHandler(bitrateConstraint: number): number | undefined {
        ...
        if (lossAvg < 0.2) {
            ...
            this.log('videoBitrateRecoveryHandler increase bitrate to ' + this._formatBitrate(bitrate)).info();
            return bitrate;
        }
        if (lossAvg < 5.0) {
            this._increaseRecoveryTimeout();
            ...
            this.log('videoBitrateRecoveryHandler decrease bitrate to ' + this._formatBitrate(bitrate)).info();
            return bitrate;
        }
    }
