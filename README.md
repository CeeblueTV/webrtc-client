...
- Two implementations of the [IStats](./src/stats/IStats.ts) interface:
  - [PlayerStats](./src/stats/PlayerStats.ts) class that serializes the Player [Player](./src/Player.ts).
  - [StreamerStats](./src/stats/StreamerStats.ts) class that serializes the Player [Streamer](./src/Streamer.ts).
